...
// Importamos el server (que NO arranca solo gracias al require.main check)
const server = require('../src/index.js');

// Helper para hacer peticiones al server en un puerto temporal
...
test('GET / devuelve 200 y un mensaje', async () => {
  ...
  assert.strictEqual(res.statusCode, 201); // BUG intencional - demo pipeline rojo
